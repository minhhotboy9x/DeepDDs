...
from models.gat_edge import EdgedGATNet
...
for i in range(5):
    ...
    model_file_name = 'data/result/EdgedGATNet(DrugA_DrugB)' + str(i) + '--model_' + datafile +  '.model'
    result_file_name = 'data/result/EdgedGATNet(DrugA_DrugB)' + str(i) + '--result_' + datafile + '.csv'
    file_AUCs = 'data/result/EdgedGATNet(DrugA_DrugB)' + str(i) + '--AUCs--' + datafile + '.txt'
