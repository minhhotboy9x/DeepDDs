...
from multi_models.gat import MultiGATNet
...
datafile = 'new_labels_0_10_drp_filtered'
...
for i in range(5):
    ...
    model_file_name = 'data/result/MultiGATNet(DrugA_DrugB)' + str(i) + '--model_' + datafile +  '.model'
    result_file_name = 'data/result/MultiGATNet(DrugA_DrugB)' + str(i) + '--result_' + datafile + '.csv'
    file_AUCs = 'data/result/MultiGATNet(DrugA_DrugB)' + str(i) + '--AUCs--' + datafile + '.txt'
