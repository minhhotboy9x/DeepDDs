...
from models.gat_trans_edge import EdgedGATTransNet
...
drug1_data = TestbedEdgeDataset(root='data', dataset=datafile + '_drug1')
drug2_data = TestbedEdgeDataset(root='data', dataset=datafile + '_drug2')
...
for i in range(5):
    ...
    model_file_name = 'data/result/EdgedGATTransNet(DrugA_DrugB)' + str(i) + '--model_' + datafile +  '.model'
    result_file_name = 'data/result/EdgedGATTransNet(DrugA_DrugB)' + str(i) + '--result_' + datafile + '.csv'
    file_AUCs = 'data/result/EdgedGATTransNet(DrugA_DrugB)' + str(i) + '--AUCs--' + datafile + '.txt'
